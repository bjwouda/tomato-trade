export default {
  ...
  "tutorial": {
    "player": {
      ...
      "tradeTutorial5": "The other player has accepted your offer! You can now choose to either <strong>confirm</strong> this offer if you are still satisfied with it, or <strong>recall</strong> the offer if you no longer wish to trade. For tutorial purposes, confirm your offer by pressing the <strong>Confirm</strong> button.",
