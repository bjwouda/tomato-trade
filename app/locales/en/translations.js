export default {
  ...
  "tutorial": {
    "player": {
      ...
      "sellerPropertiesConclusion": "And make sure to sell all of your supply. Any remaining tomatoes will <strong>spoil</strong> and have be <strong>dumped</strong>. Remember that the supply can change with up to <strong>10%</strong> and will only be made definitive at the start of the <strong>daily trade</strong>.",
      ...
      "tradeTutorial5": "The other player has confirmed your offer! You can now choose to either <strong>accept</strong> this offer if you are still satisfied with it, or <strong>recall</strong> the offer if you no longer wish to trade. For tutorial purposes, accept your offer by pressing the <strong>Accept</strong> button.",
